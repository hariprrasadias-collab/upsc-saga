...
## 2024-08-14 - Hiding Visual Emojis in Icon-Only Buttons
...
**Action:** Always wrap visual elements in icon-only buttons with `<span aria-hidden="true">` when providing an `aria-label`.
