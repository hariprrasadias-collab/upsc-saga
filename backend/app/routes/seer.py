...
def get_year_trends():
    ...
    try:
        ...
        # Get all counts grouped by year and subject in a single query (Bolt Optimization: N+1 to O(1) query)
        ...
        # Map to quickly access counts by (year, subject)
        ...
        for row in all_counts:
            ...
            counts_by_year_subject[y][s] = row['count']
