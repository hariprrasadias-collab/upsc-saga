...
def consult_the_seer():
    ...
    # ⚡ Bolt Optimization: Fetches 7 days of XP data in one query to prevent N+1 bottleneck
...
def get_year_trends():
    ...
    try:
        ...
        # ⚡ Bolt Optimization: O(1) query mapping to avoid querying counts inside loop
        counts = conn.execute('''
