...
def get_boss_stats(boss_type, boss_id, precalculated_count=None):
    ...
    if boss_type == 'YEAR':
        ...
        # Bolt optimization: use precalculated_count to avoid N+1 queries in get_available_bosses
...
def get_available_bosses():
    ...
    # Year Bosses
    # Bolt optimization: fetch counts in a single query instead of N+1 COUNT(*) queries
