...
def get_available_bosses():
    ...
    # ⚡ Bolt Optimization: Fetched total count for all year and subject bosses in single queries
    # to eliminate N+1 query issue inside get_boss_stats() where it ran COUNT(*) for each item.
