...
def get_available_bosses():
    ...
    # Year Bosses - ⚡ Bolt: Fetch all years and counts in a single query to avoid N+1 problem
    years = conn.execute(
    ...
    # Subject Bosses - ⚡ Bolt: Fetch all subjects and counts in a single query to avoid N+1 problem
