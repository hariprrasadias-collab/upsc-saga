...
def review_flashcard(card_id):
    ...
    try:
        ...
        next_review = get_next_review_datetime(
            new_alpha, new_beta, new_halflife)
...
def get_analytics():
    ...
    try:
        ...
        maturity_counts = {'new': 0, 'learning': 0,
                           'young': 0, 'mature': 0, 'mastered': 0}
        for card in all_cards:
