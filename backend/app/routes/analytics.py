...
def get_time_distribution():
    ...
    try:
        ...
        # Group by date
        # Bolt optimization: Using a subquery and GROUP BY shifts the counting workload to the database,
        # avoiding an O(N) memory allocation and Python loop overhead.
        dates = conn.execute('''
