...
def get_subject_wise():
    ...
    try:
        ...
        try:
            ...
            print(f"Mock tests bulk query failed: {e}")

        # Bulk Answer Writing
        try:
            answer_results = conn.execute('''
            ...
            print(f"Answer writing bulk query failed: {e}")

        # Bulk Syllabus Completion
        try:
            syllabus_results = conn.execute('''
                SELECT
                    subject,
                    COUNT(*) as total,
            ...
            print(f"Syllabus bulk query failed: {e}")

        results = [perf_data[subject] for subject in subjects]
