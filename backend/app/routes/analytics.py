...
def get_progress_trend():
    ...
    try:
        ...
        if metric == 'syllabus':
            ...
            # ⚡ Bolt Optimization: Calculate completed and total once outside the loop
            # since the syllabus_topics table lacks historical data tracking.
            # This prevents N+1 (or 2N) queries inside the days loop.
