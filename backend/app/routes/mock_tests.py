...
def submit_attempt(attempt_id):
    ...
    try:
        ...
        # Bolt Optimization: Batch test answer grading updates using executemany
        # to avoid N+1 query problem inside the loop.
        # Impact: O(N) database queries reduced to O(1) (at most 2 queries).
        if correct_params:
            conn.executemany(
