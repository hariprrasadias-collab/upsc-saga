...
def calculate_exam_readiness():
    ...
    try:
        ...
        print(f"Error in calculate_exam_readiness: {e}")
        return {
            'overall_score': 0,
            'breakdown': {'topic_coverage': 0, 'study_hours': 0, 'mock_performance': 0, 'consistency': 0},
            'recommendations': ["Not enough data to calculate readiness."]
        }
...
def calculate_success_probability():
    ...
    try:
        ...
        print(f"Error in calculate_success_probability: {e}")
        return {'probability': 0, 'confidence': 'low', 'message': 'Unable to calculate probability due to missing data'}
...
def calculate_optimal_study_time():
    ...
    try:
        ...
        print(f"Error in calculate_optimal_study_time: {e}")
        return {'message': 'Unable to determine optimal study time', 'peak_hours': []}
...
def detect_burnout():
    ...
    try:
        ...
        print(f"Error in detect_burnout: {e}")
        return {'burnout_risk': 'unknown', 'message': 'Unable to detect burnout due to missing data'}
