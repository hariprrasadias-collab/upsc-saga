...
def get_all_subjects_performance(conn, user_id, subjects):
    """
    Aggregate all metrics for multiple subjects in batched queries to prevent N+1 issues.
    """
    results = {subj: {
        'subject': subj,
        'mock_avg': 0,
    ...
    try:
        ...
        print(f"Batched mock test error: {e}")
    ...
    try:
        ...
        print(f"Batched answer writing error: {e}")
    ...
    try:
        ...
        print(f"Batched syllabus error: {e}")
