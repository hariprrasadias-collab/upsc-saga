...
- Name: tests/sidebar.spec.ts >> Sidebar Navigation E2E Tests >> should navigate to every item in ⚡ Enhancement
...
Call log:
  - waiting for locator('button.group-header:has-text("⚡ Enhancement")')
