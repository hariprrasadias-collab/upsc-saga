...
- Name: tests/sidebar.spec.ts >> Sidebar Navigation E2E Tests >> should navigate to every item in 🗺️ Planning
...
Locator: locator('.group-items button:has-text("Study Plan")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.group-items button:has-text("Study Plan")')
