                ...
                {isEditing ? (
                    <div className="timer-edit-overlay">
                        ...
                        <div className="timer-edit-actions">
                            <button onClick={handleEditSave} className="save-btn" aria-label="Save">✓</button>
                            <button onClick={() => setIsEditing(false)} className="cancel-btn" aria-label="Cancel">✕</button>
                        </div>
                    </div>
                ) : (
