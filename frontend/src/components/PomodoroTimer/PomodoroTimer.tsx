        ...
        <div className={`pomodoro-widget ${className || ''} ${isFullscreen ? 'fullscreen' : ''}`}>
            ...
            <div className="pomodoro-header">
                ...
                <div className="pomodoro-controls">
                    <button aria-label={isFullscreen ? "Exit Fullscreen" : "Fullscreen"} aria-expanded={isFullscreen} onClick={() => setIsFullscreen(!isFullscreen)} className="settings-btn" title={isFullscreen ? "Exit Fullscreen" : "Fullscreen"}>
                        {isFullscreen ? '↙️' : '⛶'}
                    </button>
                    {isFullscreen && (
                    ...
                    <button aria-label="Toggle Session History" aria-expanded={showHistory} onClick={() => setShowHistory(!showHistory)} className="settings-btn" title="History">📊</button>
                    <button aria-label="Toggle Settings" aria-expanded={showSettings} onClick={() => setShowSettings(!showSettings)} className="settings-btn" title="Settings">⚙️</button>
                ...
                {isEditing ? (
                    <div className="timer-edit-overlay">
                        ...
                        <div className="timer-edit-actions">
                            <button aria-label="Save Edited Time" onClick={handleEditSave} className="save-btn">✓</button>
                            <button aria-label="Cancel Edit Time" onClick={() => setIsEditing(false)} className="cancel-btn">✕</button>
                        </div>
                    </div>
                ) : (
