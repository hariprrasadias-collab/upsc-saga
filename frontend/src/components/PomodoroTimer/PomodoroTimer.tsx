        ...
        <div className={`pomodoro-widget ${className || ''} ${isFullscreen ? 'fullscreen' : ''}`}>
            ...
            <div className="pomodoro-header">
                ...
                <div className="pomodoro-controls">
                    ...
                    <button aria-label="History" onClick={() => setShowHistory(!showHistory)} className="settings-btn" title="History"><span aria-hidden="true">📊</span></button>
                    <button aria-label="Settings" onClick={() => setShowSettings(!showSettings)} className="settings-btn" title="Settings"><span aria-hidden="true">⚙️</span></button>
                ...
                {isEditing ? (
                    <div className="timer-edit-overlay">
                        ...
                        <div className="timer-edit-actions">
                            <button aria-label="Save" onClick={handleEditSave} className="save-btn"><span aria-hidden="true">✓</span></button>
                            <button aria-label="Cancel" onClick={() => setIsEditing(false)} className="cancel-btn"><span aria-hidden="true">✕</span></button>
                        </div>
                    </div>
                ) : (
