        ...
        <div className={`pomodoro-widget ${className || ''} ${isFullscreen ? 'fullscreen' : ''}`}>
            ...
            <div className="pomodoro-header">
                ...
                <div className="pomodoro-controls">
                    ...
                    <button aria-label="History" onClick={() => setShowHistory(!showHistory)} className="settings-btn" title="History">📊</button>
                    <button aria-label="Settings" onClick={() => setShowSettings(!showSettings)} className="settings-btn" title="Settings">⚙️</button>
                    <button aria-label="Minimize" onClick={() => setIsMinimized(true)} className="minimize-btn" title="Minimize">−</button>
                </div>
            </div>
