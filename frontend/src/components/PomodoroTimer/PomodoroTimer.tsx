        ...
        <div className={`pomodoro-widget ${className || ''} ${isFullscreen ? 'fullscreen' : ''}`}>
            ...
            <div className="pomodoro-header">
                ...
                <button onClick={() => setIsFullscreen(!isFullscreen)} className="settings-btn" aria-label={isFullscreen ? "Exit Fullscreen" : "Fullscreen"} title={isFullscreen ? "Exit Fullscreen" : "Fullscreen"}>
                    ...
                    {isFullscreen && (
                    <button onClick={() => setIsFullscreen(false)} className="settings-btn close-fullscreen" aria-label="Close Fullscreen" title="Close">✕</button>
                    )}
                <button onClick={() => setShowHistory(!showHistory)} className="settings-btn" aria-label="View History" title="History">📊</button>
                <button onClick={() => setShowSettings(!showSettings)} className="settings-btn" aria-label="Open Settings" title="Settings">⚙️</button>
                <button onClick={() => setIsMinimized(true)} className="minimize-btn" aria-label="Minimize Timer" title="Minimize">−</button>
                </div>
            </div>
