        ...
        <div className={`pomodoro-widget ${className || ''} ${isFullscreen ? 'fullscreen' : ''}`}>
            ...
            <div className="pomodoro-header">
                ...
                <div className="pomodoro-controls">
                    ...
                    {isFullscreen && (
                        <button onClick={() => setIsFullscreen(false)} className="settings-btn close-fullscreen" title="Close" aria-label="Close">
                            <span aria-hidden="true">✕</span>
                        </button>
                    )}
                    <button onClick={() => setShowHistory(!showHistory)} className="settings-btn" title="History" aria-label="History">
                        <span aria-hidden="true">📊</span>
                    </button>
                    <button onClick={() => setShowSettings(!showSettings)} className="settings-btn" title="Settings" aria-label="Settings">
                        <span aria-hidden="true">⚙️</span>
                    </button>
                    <button onClick={() => setIsMinimized(true)} className="minimize-btn" title="Minimize" aria-label="Minimize">
                        <span aria-hidden="true">−</span>
                    </button>
                </div>
            </div>
