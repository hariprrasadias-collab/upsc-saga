        ...
        <div className={`pomodoro-widget ${className || ''} ${isFullscreen ? 'fullscreen' : ''}`}>
            ...
            <div className="pomodoro-header">
                ...
                <div className="pomodoro-controls">
                    ...
                    {isFullscreen && (
                        <button onClick={() => setIsFullscreen(false)} className="settings-btn close-fullscreen" title="Close" aria-label="Close"><span aria-hidden="true">✕</span></button>
                    )}
                ...
                {isEditing ? (
                    <div className="timer-edit-overlay">
                        ...
                        <div className="timer-edit-actions">
                            ...
                            <button onClick={() => setIsEditing(false)} className="cancel-btn" aria-label="Close"><span aria-hidden="true">✕</span></button>
                        </div>
                    </div>
                ) : (
