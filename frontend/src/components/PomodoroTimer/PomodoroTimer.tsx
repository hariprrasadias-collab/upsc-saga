                ...
                {isEditing ? (
                    <div className="timer-edit-overlay">
                        ...
                        <div className="timer-edit-actions">
                            <button onClick={handleEditSave} className="save-btn" aria-label="Save time"><span aria-hidden="true">✓</span></button>
                            <button onClick={() => setIsEditing(false)} className="cancel-btn" aria-label="Cancel editing"><span aria-hidden="true">✕</span></button>
                        </div>
                    </div>
                ) : (
