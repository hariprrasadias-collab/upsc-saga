        ...
        <div className={`pomodoro-widget ${className || ''} ${isFullscreen ? 'fullscreen' : ''}`}>
            ...
            <div className="pomodoro-header">
                ...
                <div className="pomodoro-controls">
                    ...
                    <button onClick={() => setShowHistory(!showHistory)} className="settings-btn" title="History" aria-label="View Session History"><span aria-hidden="true">📊</span></button>
                    <button onClick={() => setShowSettings(!showSettings)} className="settings-btn" title="Settings" aria-label="Open Settings"><span aria-hidden="true">⚙️</span></button>
                            ...
                            <>
                                ...
                                {!isRunning && (
                                    <button className="edit-time-btn" onClick={() => {
                                        ...
                                        setIsEditing(true);
                                    }} title="Edit Timer" aria-label="Edit Timer Duration"><span aria-hidden="true">✎</span></button>
                                )}
                            </>
                        )}
                    </div>
