        ...
        <div className={`pomodoro-widget ${className || ''} ${isFullscreen ? 'fullscreen' : ''}`}>
            ...
            <div className="pomodoro-header">
                ...
                <div className="pomodoro-controls">
                    ...
                    {isFullscreen && (
                        <button aria-label="Close" onClick={() => setIsFullscreen(false)} className="settings-btn close-fullscreen" title="Close"><span aria-hidden="true">✕</span></button>
                    )}
                    ...
                    <button aria-label="Minimize" onClick={() => setIsMinimized(true)} className="minimize-btn" title="Minimize"><span aria-hidden="true">−</span></button>
                </div>
            </div>
                ...
                {isEditing ? (
                    <div className="timer-edit-overlay">
                        ...
                        <div className="timer-edit-actions">
                            ...
                            <button aria-label="Cancel edit" onClick={() => setIsEditing(false)} className="cancel-btn"><span aria-hidden="true">✕</span></button>
                        </div>
                    </div>
                ) : (
