                                ...
                                <tbody>
                                    {questions.map(q => (
                                        <tr key={q.id}>
                                            ...
                                            <td>
                                                <button className="action-btn edit" aria-label="Edit question"><span aria-hidden="true">✏️</span></button>
                                                <button
                                ...
                                <tbody>
                                    {articles.map(a => (
                                        <tr key={a.id}>
                                            ...
                                            <td>
                                                <button className="action-btn edit" aria-label="Edit article"><span aria-hidden="true">✏️</span></button>
                                                <button
                                                    className="action-btn delete"
