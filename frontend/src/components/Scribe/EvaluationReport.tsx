...
const EvaluationReport: React.FC<EvaluationReportProps> = ({ data, onClose }) => {
    return (
        <div className="evaluation-overlay open" role="dialog" aria-modal="true" aria-labelledby="evaluation-report-title">
            <button className="close-report-btn" onClick={onClose} aria-label="Close report">
            ...
            <div className="report-header">
                ...
                <div className="report-title">
                    <h2 id="evaluation-report-title">EVALUATION REPORT</h2>
