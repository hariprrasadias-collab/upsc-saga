        ...
        <div className="scribe-container">
            ...
            {selectedHistoryItem && (
                <div className="modal-overlay" onClick={() => setSelectedHistoryItem(null)}>
                    <div className="modal-content history-modal" onClick={e => e.stopPropagation()} role="dialog" aria-modal="true" aria-labelledby="history-modal-title">
                        <div className="modal-header">
                            <h2 id="history-modal-title">Evaluation Details</h2>
                            <button className="close-btn" onClick={() => setSelectedHistoryItem(null)} aria-label="Close details">
