                ...
                <div className="palace-modal-overlay" onClick={() => setShowLocationModal(false)}>
                    <div className="palace-modal" onClick={e => e.stopPropagation()}>
                        <div className="modal-header">
                            ...
                            <button className="close-btn" onClick={() => setShowLocationModal(false)} aria-label="Close"><span aria-hidden="true">×</span></button>
                        </div>
                ...
                <div className="palace-modal-overlay" onClick={() => { setShowArtifactModal(false); setEditingArtifact(null); }}>
                    <div className="palace-modal" onClick={e => e.stopPropagation()}>
                        <div className="modal-header">
                            ...
                            <button className="close-btn" onClick={() => { setShowArtifactModal(false); setEditingArtifact(null); }} aria-label="Close"><span aria-hidden="true">×</span></button>
                        </div>
                        <div className="form-group">
                            <label>Title</label>
                            <input
