                            ...
                            <div className="t-col">
                                ...
                                {result.scholars.map((s, i) => (
                                    <div key={i} className="t-card scholar-card group">
                                        ...
                                        <button className="copy-btn" onClick={() => copyToClipboard(`"${s.quote}" - ${s.name}`)} aria-label="Copy quote to clipboard" title="Copy quote">📋</button>
                                    </div>
                                ))}
                            </div>
                            <div className="t-col">
                                ...
                                {result.data_bank.map((d, i) => (
                                    <div key={i} className="t-card data-card group">
                                        ...
                                        <button className="copy-btn" onClick={() => copyToClipboard(`${d.statistic} (${d.source})`)} aria-label="Copy statistic to clipboard" title="Copy statistic">📋</button>
                                    </div>
                                ))}
                            </div>
                        </div>
            ...
            <div className="triangulation-modal omni-modal">
                <div className="t-header">
                    ...
                    <div className="header-actions">
                        ...
                        <button onClick={onClose} className="close-btn" aria-label="Close dashboard" title="Close">×</button>
                    </div>
                </div>
