        ...
        <div className="tablet-overlay" onClick={onClose}>
            <div className="tablet-stone" onClick={(e) => e.stopPropagation()}>
                <div className="tablet-header">
                    <h2>{node.title}</h2>
                    <button className="close-btn" onClick={onClose} aria-label="Close tablet">✕</button>
                </div>
                    ...
                    {explanation && (
                        <div className="explanation-box" style={{
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '5px' }}>
                                ...
                                <button onClick={() => setExplanation(null)} style={{ background: 'none', border: 'none', color: '#ccc', cursor: 'pointer' }} aria-label="Close Insight">✕</button>
                            </div>
