...
const PodcastPlayer: React.FC<PodcastRendererProps> = ({ content, title }) => {
    ...
    useEffect(() => {
        ...
        const speakLine = (index: number) => {
            ...
            // const isExpert = line.speaker.toLowerCase().includes('expert') || line.speaker.toLowerCase().includes('professor') || line.speaker.toLowerCase().includes('host'); // isExpert declared but unused in this scope
